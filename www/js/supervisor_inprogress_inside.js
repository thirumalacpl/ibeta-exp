...
var insu_company = user_obja.inscompany_id;
...
//alert(oneemp);
  $('.sddqi').append('<li><a href="http://ibeta.fourthforce.in/uploads/'+oneemp+'"><img src="http://ibeta.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$.ajax({
  type: "POST",
//  url: "http://ibeta.fourthforce.in/slim-insu-quest/update_insu_fir.php?name_of_ps="+name_of_ps+"&address_of_ps="+address_of_ps+"&dist_bet_acc_ps="+dist_bet_acc_ps+"&fir_no="+fir_no+"&fir_date="+fir_date+"&delay_in_fir="+delay_in_fir+"&firsum="+firsum+"&fircoy="+fircoy+"&fir_logged_by="+fir_logged_by+"&fofname="+fofname+"&relationship_with_victim="+relationship_with_victim+"&vehicle_details="+vehicle_details+"&no_of_veh_involved="+no_of_veh_involved+"&vehicle_impleded_as_party="+vehicle_impleded_as_party+"&mvi_inspected="+mvi_inspected+"&summary_of_nvi="+summary_of_nvi+"&damage_of_vehicle="+damage_of_vehicle+"&shid_mark_obs="+shid_mark_obs+"&per_of_contribution="+per_of_contribution+"&chargesheet_filed="+chargesheet_filed+"&chargesheetcoll="+chargesheetcoll+"&sumchrge="+sumchrge+"&insu_user_id_fir="+insu_user_id_fir,  
 url: "http://ibeta.fourthforce.in/slim-insu-quest/update_insu_accide_vehicle.php?vehicle_reg_no="+vehicle_reg_no+"&vehicle_reg_date="+vehicle_reg_date+"&vehicle_purchase_date="+vehicle_purchase_date+"&vehicle_type_of_vehicle="+vehicle_type_of_vehicle+"&vehicle_purpose_of_vehicle="+vehicle_purpose_of_vehicle+"&vehicle_model="+vehicle_model+"&vehicle_color="+vehicle_color+"&vehicle_type_of_fuel="+vehicle_type_of_fuel+"&vehicle_laden_weight="+vehicle_laden_weight+"&vehicle_unladen_weight="+vehicle_unladen_weight+"&vehicle_engine_no="+vehicle_engine_no+"&vehicle_chassis_no="+vehicle_chassis_no+"&vehicle_date_of_transfer="+vehicle_date_of_transfer+"&vehicle_fc_details="+vehicle_fc_details+"&vehicle_hypothecation="+vehicle_hypothecation+"&vehicle_permit_details="+vehicle_permit_details+"&vehicle_type_of_permit="+vehicle_type_of_permit+"&vehicle_permit_num="+vehicle_permit_num+"&vehicle_date_of_permit_expiry="+vehicle_date_of_permit_expiry+"&vehicle_date_of_permit_issue="+vehicle_date_of_permit_issue+"&vehicle_details_of_opp_vehicle="+vehicle_details_of_opp_vehicle+"&vehicle_owner_of_opp_vehicle="+vehicle_owner_of_opp_vehicle+"&vehicle_km_run="+vehicle_km_run+"&accident_details_a_user_id="+accident_details_a_user_id,
 data: formData,
  success: onSuccessins,
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim-insu-quest/update_policy.php?policy_user_id="+policy_user_id+"&policy_address_groupid="+policy_address_groupid+"&pol_avl="+pol_avl+"&policy_address="+policy_address+"&policy_dtl_pol="+policy_dtl_pol+"&policy_pol_no="+policy_pol_no+"&policy_pol_srt_dt="+policy_pol_srt_dt+"&policy_pol_end_dt="+policy_pol_end_dt+"&policy_crv_nte_no="+policy_crv_nte_no+"&policy_crv_nte_srt_dt="+policy_crv_nte_srt_dt+"&policy_crv_nte_end_dt="+policy_crv_nte_end_dt+"&policy_wheth_cls_pro="+policy_wheth_cls_pro+"&policy_dt_inmit="+policy_dt_inmit+"&policy_tax_com="+policy_tax_com+"&policy_cls_vec="+policy_cls_vec,
  //url: "http://ibeta.fourthforce.in/slim-insu-quest/update_personal_table.php?img_master_id="+img_master_id+"&img_first_name="+img_first_name,
  data: formData,
  success: onSuccessins,
  async: 'true',
  crossDomain: true,
...
var oneemp=employimg_obj.document;
//alert(oneemp);
  $('.sddq').append('<li><a href="http://ibeta.fourthforce.in/uploads/'+oneemp+'"><img src="http://ibeta.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" onerror="imgError(this);"></a></li>');
...
//$('.document_imag_inprooneqc').append('<img src="http://localhost/uploads/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://ibeta.fourthforce.in/uploads/'+one+'"><img src="http://ibeta.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inprooneqd').append('<img src="http://localhost/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://ibeta.fourthforce.in/uploads/'+oneo+'"><img src="http://ibeta.fourthforce.in/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.sddq').append('<li><a href="http://ibeta.fourthforce.in/documents/addressid/'+oneemp+'"><img src="http://ibeta.fourthforce.in/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneemp');
//$('.document_imag_inprooneqc').append('<img src="http://ibeta.fourthforce.in/documents/addressid/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://ibeta.fourthforce.in/documents/addressid/'+one+'"><img src="http://ibeta.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
//$('.document_imag_inprooneqd').append('<img src="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
$('.s').append('<li><a href="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'"><img src="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');

}
if (j == 2 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqb').append('<img src="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 3 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqa').append('<img src="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 4 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqe').append('<img src="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');

}
if (j == 5 ){
  var oneo=oneaddress[j];
// alert(oneo+'two');
$('.document_imag_inprooneqf').append('<img src="http://ibeta.fourthforce.in/documents/addressid/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
...
$.ajax({url: "http://ibeta.fourthforce.in/slim-insu-quest/supervisor_status_to_verified.php?status_val_inpro="+status_val_inpro+"&verification_user_id="+verification_user_id+"&remark_inpro="+remark_inpro+"&coordinator_id="+coordinator_id+"&region_num="+region_num+"&activity_log="+activity_log+"&sdocument="+sdocument,
