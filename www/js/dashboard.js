...
//alert(region+'region');
$.ajax({url: 'http://ibeta.fourthforce.in/slim-insu-quest/dash_completeda.php?',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://ibeta.fourthforce.in/slim-insu-quest/index_verifd_insu.php?',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://ibeta.fourthforce.in/slim-insu-quest/index_compltd_insu.php?',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'inprogress');
//alert(region+'region');
$.ajax({url: 'http://ibeta.fourthforce.in/slim-insu-quest/index_insu.php',
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
var app = {
	...
	//alert(region+'region');
		//alert(user_id+'user_id');
 $.ajax({url: 'http://ibeta.fourthforce.in/slim-insu-quest/gcm_id_user.php?gcm_regid='+gcm_regid+"&E_Mail="+E_Mail+"&username="+username+"&region="+region+"&user_id="+user_id,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
