...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim-insu-quest/insur.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_nine_a="+insu_accident_nine_nine_a+"&insu_investiagtor_nine_nine_b="+insu_investiagtor_nine_nine_b+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
$.ajax({
//  url: "http://ibeta.fourthforce.in/slim-insu-quest/insur.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_five_a="+insu_accident_nine_five_a+"&insu_inves_nine_five_b="+insu_inves_nine_five_b+"&insu_final_nine_five_c="+insu_final_nine_five_c+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state,
  url: "http://ibeta.fourthforce.in/slim-insu-quest/insur-fir.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_one_zero_two_a="+insu_accident_one_zero_two_a+"&insu_investiagtor_one_zero_two_b="+insu_investiagtor_one_zero_two_b+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&claiquesa="+claiquesa+"&claiquesb="+claiquesb+"&claiquesc="+claiquesc+"&claiquesd="+claiquesd+"&claiquese="+claiquese+"&claiquesf="+claiquesf+"&claiquesg="+claiquesg+"&claiquesh="+claiquesh+"&claiquesi="+claiquesi+"&claiquesj="+claiquesj+"&claiquesk="+claiquesk+"&user_id_su="+user_id_su+"&travel_expen_102="+travel_expen_102+"&actua_exp_102="+actua_exp_102+"&misc_e_102="+misc_e_102+"&insu_company="+insu_company,
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  //url: "http://ibeta.fourthforce.in/slim-insu-quest/insur.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_accident_nine_five_a="+insu_accident_nine_five_a+"&insu_inves_nine_five_b="+insu_inves_nine_five_b+"&insu_final_nine_five_c="+insu_final_nine_five_c+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state,
  url: "http://ibeta.fourthforce.in/slim-insu-quest/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_six="+insu_final_one_zero_six+"&status="+status+"&region="+region+"&user_id="+user_id+"&state="+state+"&travel_expen="+travel_expen+"&actua_exp="+actua_exp+"&misc_e="+misc_es+"&insu_company="+insu_company,
  data:$('#insuform').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim-insu-quest/one_zero_six.php?verification_user_id="+verification_user_id+"&qualification_id="+qualification_id+"&user_id="+user_id+"&state="+state+"&insu_final_one_zero_six="+insu_final_one_zero_six+"&status="+status,
  data: formData,
  success: onSuccessad,
  async: 'true',
  crossDomain: true,
...
var imz='<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right" style="background-color:#BC3217;width:50px;height: 50px;">Close</a><img src="http://ibeta.fourthforce.in/super/'+img_id+'" alt="Photo portrait" class="imgzz imguirot">'
$('.imj').append(imz);
});
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim-insu-quest/delete.php?del_id="+del_id,
...
$.ajax({
  type: "POST",
url: "http://ibeta.fourthforce.in/slim-insu-quest/sdoc.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&res="+res+"&qualification_id="+qualification_id+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim-insu-quest/chat.php?loginistant="+loginistant+"&verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&status_val_inpro="+status_val_inpro+"&remarkg="+remarkg+"&qualification_id="+qualification_id+"&username="+username+"&typofver="+typofver+"&pertobever="+pertobever+"&pertobeverlast="+pertobeverlast+"&task="+task+"&eeemail="+eeemail+"&user_id="+user_id,
...
$.ajax({
  type: "POST",
  url: "http://ibeta.fourthforce.in/slim-insu-quest/lifeint.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&qualification_id="+qualification_id+"&inte="+inte+"&inte_rat="+inte_rat+"&beh="+beh+"&beh_rat="+beh_rat+"&hab="+hab+"&hab_rat="+hab_rat,
...
// $('#myPopupr').hide();
$.ajax({url: 'http://ibeta.fourthforce.in/slim-insu-quest/count.php?region='+region+"&user_id="+user_id+"&state="+state,
